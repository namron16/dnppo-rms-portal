...
export function AddMasterDocAttachmentModal({
  ...
  async function handleSubmit() {
    ...
    if (!file) {
      setErrors((prev) => ({
        ...prev,
        file: "Please select a file to attach.",
      }));
      return;
    }
    ...
    >
      <div className="p-6 space-y-4">
        ...
        <div className="flex items-start gap-2.5 px-3.5 py-2.5 bg-blue-50 border border-blue-200 rounded-lg">
          <span className="text-blue-500 text-lg flex-shrink-0 leading-none mt-0.5">
            ℹ
          </span>
          <p className="text-xs text-blue-700 leading-relaxed">
            Attachments follow the PNP hierarchy: Regional → Provincial →
            Station. Fill in the details for this supporting document before
            uploading.
          </p>
        </div>
