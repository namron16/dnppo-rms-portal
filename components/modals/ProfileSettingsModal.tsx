  ...
  async function handleProfileSave() {
    ...
    try {
      ...
      if (!avatarUrl) {
        ...
        avatarUrl =
          currentPrefs.avatarUrl?.split("?")[0] ?? user?.avatarUrl ?? undefined;
      }
      ...
      if (user) {
        ...
        if (!saved) {
          toast.error(
            "Profile saved locally, but cloud sync failed. Check Supabase permissions/policies."
          );
          return;
        }
      }
  ...
  return (
    <>
      ...
      <div
        ...
        className={`fixed z-[1060] transition-all duration-200 inset-x-4 top-4 bottom-4 md:inset-x-auto md:left-[252px] md:top-4 md:bottom-4 md:w-[360px] ${
          closing
      ...
      >
        <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col max-h-[calc(100vh-32px)]">
            ...
            <div className="flex items-center gap-3">
              <div className="relative group flex-shrink-0">
                <div
                  ...
                  style={{
                    background: photoPreview ? "transparent" : avatarBg,
                  }}
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-white/50 text-[11px] capitalize mt-0.5">
              ...
              <div className="p-5 space-y-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-400 mt-1">
                    Updates your sidebar display name only.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-400 mt-1">
                    Email changes must be requested from your system
                    administrator.
                  </p>
                </div>
                  ...
                  <div className="flex items-center gap-3 px-3 py-3 bg-blue-50 border border-blue-200 rounded-xl">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[10px] text-slate-400">
                        {(photoFile.size / 1024 / 1024).toFixed(2)} MB · Will
                        sync across devices
                      </p>
                    </div>
                    <button
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-slate-400">
                        JPG, PNG, WebP — max 5 MB · Synced across all devices
                      </p>
                    </div>
                  </button>
                )}
            ...
            {tab === "password" && (
              <div className="p-5 space-y-4">
                <div className="flex items-start gap-2 px-3 py-3 bg-amber-50 border border-amber-200 rounded-xl text-xs text-amber-800">
                  ...
                  <span>
                    Use a strong password (min. 8 characters, mix of
                    upper/lower, numbers &amp; symbols). You remain logged in
                    after changing.
                  </span>
                </div>
          ...
          <div className="flex-shrink-0 px-5 py-3 border-t border-slate-100 bg-slate-50 flex items-center justify-between">
            <p className="text-[10px] text-slate-400">
              Logged in as{" "}
              <span className="font-bold text-slate-600">{user?.role}</span>
            </p>
